...
<u><h4><i class="fas fa-file-alt" style="margin-right:6px; font-size:30px; color:#0099ff;"></i>ລາຍງານຊ່ວງເວລາທີ່ຂາຍດີ</h4></u><hr>
    ...
    <div class="row">
        ...
        <div class="col-sm-9">
            ...
            <!-- <button type="button" class="btn btn-primary" onclick="window.open('check_buy_list_print.php?date_start='+document.getElementById('date_start').value+'&date_end='+document.getElementById('date_end').value);"><i class="fas fa-print"></i><br>ພິມລາຍການ</button> -->
