...
<u><h4><i class="fas fa-coins" style="margin-right:6px; font-size:30px; color:#0099ff;"></i>ລາຍງານການຮັບຊຳລະໜີ້ຈາກລູກຄ້າ</h4></u><hr>
    ...
    <div class="row">
        ...
        <div class="col-sm-9">
            ...
            <button id="txuav" onclick="window.open('check_recieve_list_print.php?date_start='+document.getElementById('date_start').value+'&date_end='+document.getElementById('date_end').value);" type="button" class="btn btn-primary"><i class="fas fa-print"></i><br>ພິມລາຍການ</button>
