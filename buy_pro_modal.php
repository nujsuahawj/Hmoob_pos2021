...
<div class="modal fade" id="buy_pro_modal" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
                ...
                <div class="col-sm-8">
                    <form class="form-inline">
                        <div class="form-group">
                            ...
                            if(this.value!='')ajax('buy_pro_list&txt_search='+this.value+'&cb_search='+
                            document.getElementById('cb_search').value,'buy_pro_list');
                            ">
                        </div>
                    </form>
                </div>
